...
def lucky_word_write():
    ...
    outtext_words = list(luck_dict_choice.values())[0][1]
    return outtext, outtext_words
...
def get_signin_img(
    ...
    draw.text(
        ...
        cut_text(font_lucky_words, luck_words, 100),
        font=font_lucky_words,
        fill=text_color,
        spacing=12,
    )  # 最大不要超过5行
