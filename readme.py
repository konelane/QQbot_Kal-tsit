...
print('【PRTS查询】输入#prts 干员名称 项目【项目包括：技能专精,晋升材料,属性,后勤,生日】')
print('demo:#prts 德克萨斯 技能专精')
print('【天气/地图】输入#天气 地点名 今日【或#地图 地点名 显示范围】')
print('')
# print('--------cos干员--------')
# print('权限系统、爬虫性能优化、建立数据库')
print('-----最新更新&目前工作-----')
print('权限系统【已配置未实装】、爬虫性能优化【done！】、建立数据库【done！】、天文爱好者天气/星象预报【开发中】、优化功能触发模块【未开始】')
