...
class operator:
    ...
    def opt_upgrade(self):
        ...
        if opt_dict['level'] != levelnow:
            ...
            print('升级属性变化：\n',
                'charm',opt_dict['charm'],'+',charm_p,'\n',
                'agile',opt_dict['agile'],'+',agile_p,'\n',
                'intelligence',opt_dict['intelligence'],'+',intel_p,'\n',
                'strength',opt_dict['strength'],'+',stren_p,'\n',
                'hp_upper',opt_dict['hp_upper'],'+',stren_p*5,'\n',
                'sanity_upper',opt_dict['sanity_upper'],'+',intel_p*5,'\n'
            )
            opt_dict['charm'] = int(opt_dict['charm'])+charm_p
            opt_dict['agile'] = int(opt_dict['agile'])+agile_p
            opt_dict['intelligence'] = int(opt_dict['intelligence'])+intel_p
            opt_dict['strength'] = int(opt_dict['strength'])+stren_p
            opt_dict['hp_upper'] = int(opt_dict['hp_upper']) + stren_p*5
            opt_dict['sanity_upper'] = int(opt_dict['sanity_upper']) + intel_p*5
            self.write_opt(opt_dict)
